...
public class MyTitleWindow extends TitleWindow {
  ...
  private function setTitle(name:String):void {
    //titleBar.removeChild(titleLabel);
    titleLabel.setStyle("fontFamily", "tahoma");
    titleLabel.setStyle("color", "#000000");
    titleLabel.setStyle("fontSize", 12);
    titleLabel.setStyle("fontSharpness", -150);
    titleLabel.setStyle("fontThickness", 10);
